...
# TODO: replace this with your own generated secret key.
SECRET_KEY = ''

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

# TODO: add your deployment URL to the below structure.
ALLOWED_HOSTS = []
...
# TODO: define your environment path as appropriate.
ENV_PATH = ""
...
# TODO - don't use sqlite3 in production. Instead connect to a MySQL or PostgreSQL instance.
